...
<li>
<ul>A Hub VNet with a Subnet
<ul>2 new VMs and create a new  AD forest and domain, each VM will be created as a DC for the new domain and will be placed in separate availability zones.
<ul>An Azure Key Vault with the following secrets:
<ul>A Staging storage account for the Milky Way liked templates to be uploaded
    </li>
